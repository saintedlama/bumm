...
module.exports = function(defaults, override, cb) {
    ...
    prompt.get({
        properties: {
            ...
            'dependencies' : { description: 'dependencies', default: 'express: 3.4.x, jade: 0.35.x, mongoose: 3.6.x' },
            'devDependencies' : { description: 'devDependencies', default: 'mocha: 1.13.x' },
