...
var createApp = function(data) {
    ...
    if (data.mongoSessionStore[0] == "y" && data.dependencies.indexOf("connect-mongo") == -1) {
       data.dependencies += ", connect-mongo: 0.3.x";
    }
    if (data.i18n[0] == "y" && data.dependencies.indexOf("i18n-2") == -1) {
       data.dependencies += ", i18n-2: 0.4.x";
    }
